    ...
    return (
        <Container>
            <Row className='justify-content-md-center' id="contact">
                <Col lg='8'>
                    <h1 className='title-contact'>My Contact</h1>
                    <Row className='justify-content-md-center' style={{ marginTop: 50 }}>
                        <Col className='col-md-1 social-media ' style={{ marginRight: '10px' }}>
                            <a href='https://www.linkedin.com/in/jeremia-sibarani-4a6a5b174/' target='_blank' rel="noreferrer">
                        ...
                        <Col className='col-md-1 social-media' style={{ marginRight: '10px' }}>
                            <a href='https://github.com/jeremia27' target='_blank' rel="noreferrer">
                        ...
                        <Col className='col-md-1 social-media'>
                            <a href="whatsapp://send?phone=6282167401737" target="_blank" rel="noreferrer">
